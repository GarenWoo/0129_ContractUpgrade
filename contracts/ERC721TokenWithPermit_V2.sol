 ...
 * @author Garen Woo
 */
contract ERC721TokenWithPermit_V2 is
    ERC721URIStorage,
    EIP712,
    Nonces,
    NFTMarket_Standard_Interface_V1
{
    ...
    function NFTPermit_PrepareForBuy(
        ...
        bytes32 PERMIT_TYPEHASH = keccak256(
            "NFTPermit_PrepareForBuy(address buyer,uint256 tokenId,uint256 signerNonce,uint256 deadline)"
        );
    ...
    function supportsInterface(
        ...
        return
            _interfaceId == type(NFTMarket_Standard_Interface_V1).interfaceId ||
